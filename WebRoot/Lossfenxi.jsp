...
<li class="active"><span>客户流失分析</span></li>
</ol>
<div class="clearfix">
...
<form action="lossfenxiduo" method="post">
<div align="center">
<table>
	<tr>
		<td>客户名称:<input type="text" name="vo.customer.customerName" value="${vo.customer.customerName}" class="form-control" style="width: 300px"/></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<th class="text-center"><span>年份</span></th>
...
<fmt:formatDate value="${l.lossDate }" var="date" pattern="yyyy"/>${date }
</td>
<td class="text-center">
...
<li>
<pg:pager items="${pageMax}" url="lossfenxifenye" maxPageItems="4" maxIndexPages="4"
									...
									<pg:pages>
										<c:choose>
											<c:when test="${curPage == pageNumber}">
												<a href="Lossanalysis">当前页面${pageNumber }</a>
											</c:when>
											<c:otherwise>
