					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown profile-dropdown"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="img/3.jpg" alt="" /> <span
								class="hidden-xs">张学友</span> <b class="caret"></b>
						</a>
				...
				<div id="nav-col">
					...
					<div id="col-left-inner" class="col-left-nano-content">
						<div id="user-left-box" class="clearfix hidden-sm hidden-xs">
							...
							<div class="user-box">
								<span class="name"> Welcome<br /> 张学友
					...
					<div class="row" >
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="Loss.jsp">用户管理</a></li>
										<li class="active"><span>添加用户</span></li>
									</ol>
													...
													<h1></h1>
														<table align="right">
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="#" style="color: #06060B">帮助</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="user.userPwd" value="">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="user.userTel" value="">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="user.registerData" value="<%=str_date1 %>">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="user.trueName" value="">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
