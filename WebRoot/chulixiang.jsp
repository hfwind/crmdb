            ...
            <c:if test="${zi.pid eq fu.navId}">
               <c:forEach var="po" items="${polist}">
				...
				<div id="content-wrapper">
					<div class="row" >
					<form action="chufuwu" method="post">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="index.jsp">客户服务管理</a></li>
										<li class="active"><span>服务处理详情</span></li>
									</ol>
															...
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="chulifuwu" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea name="servicemanager.profile" >${servicemanager.profile}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="servicemanager.customerName" value="${servicemanager.customerName}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea name="servicemanager.serviceRequest">${servicemanager.serviceRequest}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="servicemanager.createPerson" value="${user.trueName}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix" >
<input type="text" name="servicemanager.serviceDate" value="<%=str_date1 %>" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<textarea  name="jieguoName">${servicemanager.serviceProcssing}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input  type="text" name="${servicemanager.procesTime }" value="<%=str_date1 %>" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="" value="" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select disabled="disabled" style="height: 30px;width: 200px;">
<option>请选择</option>
</select>
</header>
<div class="main-box-body clearfix">
