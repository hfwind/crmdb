					...
					<div class="row" >
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="Loss.jsp">客户流失管理</a></li>
									 ...
									 <div class="main-box no-header clearfix" style="height:"><!-- 板块 -->
										<div class="main-box-body clearfix">
											<div class="table-responsive" >
												<form action="Byidzanhuanupda?id=${culoss.lossId}" method="post">
													<div align="center">
													<h1>客户关系暂缓流失修改页</h1>
														<table align="right">
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="loss" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="javascript:idliushi(${culoss.lossId})" style="color: #06060B">确认流失</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2>${culoss.buy.customer.customerNumber}</h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<h2>${culoss.buy.customer.customerName}</h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2>${culoss.buy.customer.user.trueName}</h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<h2><fmt:formatDate value='${culoss.buy.buyDate}' pattern='yyyy-MM-dd' /></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2><input type="text" name="yuanzanhuanls" value="${culoss.reprieve}"  style="BACKGROUND-COLOR:transparent;border-style:none;width: 700px"/></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2><textarea rows="3" cols="66" name="zhuijia"></textarea></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
