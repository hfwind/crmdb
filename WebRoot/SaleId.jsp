...
<form action="jihuashaixuan" method="post">
<div align="center">
<table>
	<tr>
...
<th class="text-center" style="width: 30"><span>操作</span></th>
</tr>
</thead>
<tbody>
<c:forEach var="s" items="${sclist}">
  <c:if test="${user.userId eq s.userinfo.userId}">
<tr>
<td>
${s.saleId}
</td>
...
<span class="fa-stack">
<img style="width: 30px" title="开发成功" src="img/chenggong.gif" class="op_button" />
</span>
</c:if>
<c:if test="${s.state eq 1 }">
<a href="kaifajihua?saleId=${s.saleId}" class="table-link">
<span class="fa-stack">
<img style="width: 30px" title="开发计划" src="img/zhixingjihua.gif" class="op_button" />
</span>
</a>

<a href="Development?saleId=${s.saleId}" class="table-link">
<span class="fa-stack">
<img style="width: 30px" title="制定计划" src="img/zhidingjihua.gif" class="op_button" />
</span>
</a>
</c:if>
...
<span class="fa-stack">
<img style="width: 30px" title="开发失败" src="img/shibai.gif" class="op_button" />
</span>
</c:if>
</td>
</tr>
...
<li>
<pg:pager items="${pageMax }" url="jihuafenye" maxPageItems="4" maxIndexPages="4" export="curPage=pageNumber">
									<pg:first>
										<a href="<%=pageUrl%>">首页</a>
									</pg:first>
