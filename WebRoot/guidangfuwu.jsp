...
function guidangxiangService(id){

location="guidangService?serviceId="+id;
...
<li class="active"><span>服务归档</span></li>
</ol>
<div class="clearfix">
...
<form action="shaixuanserver" method="post">
<div align="center">
<table>
	<tr>
		<td>客户名称</td>
...
<span class="label label-warning">${g.profile}</span>
</td>
<td class="text-center">
${g.serviceType}
</td>
...
<td class="text-center">
<c:if test="${g.state==1}" >新创建</c:if>
<c:if test="${g.state==2}" >已分配</c:if>
<c:if test="${g.state==3}" >已处理</c:if>
<c:if test="${g.state==4}" >已反馈</c:if>
