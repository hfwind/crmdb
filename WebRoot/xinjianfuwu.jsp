            ...
            <c:if test="${zi.pid eq fu.navId}">
               <c:forEach var="po" items="${polist}">
				...
				<div id="content-wrapper">
					<div class="row" >
					<form action="addfuwu" method="post">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="index.jsp">客户服务管理</a></li>
										<li class="active"><span>服务创建</span></li>
									</ol>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select name="servicemanager.serviceType" style="height: 30px;width: 200px;">
<option >请选择</option>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea name="servicemanager.profile"></textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="servicemanager.customerName" value="" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea name="servicemanager.serviceRequest"></textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select disabled="disabled" name="servicemanager.userinfo.trueName" style="height: 30px;width: 200px;">
<option>请选择</option>
<option></option>
</select>
</header>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select name=""style="height: 30px;width: 200px;" disabled="disabled">
<option></option>
</select>
</header>
<div class="main-box-body clearfix">
