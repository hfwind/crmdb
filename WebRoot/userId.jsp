									 ...
									 <div class="main-box no-header clearfix" style="height:"><!-- 板块 -->
										<div class="main-box-body clearfix">
											<div class="table-responsive" >
												<form action="xiuuser?id=${user.userId}" method="post">
													<div align="center">
													<h1>修改用户信息</h1>
														<table align="right">
															<tr>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="user.userPwd" value="${user.userPwd}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="user.registerData" value="<fmt:formatDate value="${user.registerData}" pattern="yyyy-MM-dd"/>">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
