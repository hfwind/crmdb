									 ...
									 <div class="main-box no-header clearfix" style="height:"><!-- 板块 -->
										<div class="main-box-body clearfix">
											<div class="table-responsive" >
												<form action="Updaperson?id=${person.personId}" method="post">
													<div align="center">
													<h1>客户联系人修改页</h1>
														<table align="right">
															<tr>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="person.personName" value="${person.personName}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="person.personSex" value="${person.personSex}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="person.personPosition" value="${person.personPosition}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="person.personPhone" value="${person.personPhone}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="person.personTel" value="${person.personTel}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="person.personRemarks" value="${person.personRemarks}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
