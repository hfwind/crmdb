            ...
            <c:if test="${zi.pid eq fu.navId}">
               <c:forEach var="po" items="${polist}">
				...
				<div id="content-wrapper">
					<div class="row" >
					<form action="updateSale?saleId=${salechance.saleId}" method="post">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select name="salechance.userinfo.userId" value="salechance.userinfo.trueName" style="height: 30px;width: 200px;" disabled="disabled">
<option></option>
</select>
</header>
<div class="main-box-body clearfix">
