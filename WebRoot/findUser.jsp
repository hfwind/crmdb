...
<span class="hidden-xs">张学友</span> <b class="caret"></b>
</a>
...
<div class="clearfix">
<h1 class="pull-left">用户信息管理</h1>
<div class="pull-right top-page-ui">
<a href="getrole" class="btn btn-primary pull-right">
<i class="fa fa-plus-circle fa-lg"></i> Add user
<span class="fa-stack"  title="添加" >
</a>
</div>
</div>
</div>
...
<th class="text-center"><span>电话</span></th>
<th class="text-center"><span>角色</span></th>
<th class="text-center"><span>注册日期</span></th>
...
<td class="text-center">
<span class="label label-warning">${user.userTel}</span>
</td>
<td class="text-center">
${user.role.roleName}
</td>
<td class="text-center">
<fmt:formatDate value="${user.registerData}" pattern="yyyy-MM-dd"/>
</td>
<td class="text-center">
${user.state==1? "在线" : "离职"}
</td>
<td style="width: 20%;">
<a href="userById?id=${user.userId}" class="table-link">
<span class="fa-stack" title="修改">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
</span>
</a>
<a href="deleteuser?id=${user.userId}" class="table-link danger" title="删除">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
