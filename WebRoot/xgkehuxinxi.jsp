					...
					<div class="row">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="index.jsp">客户信息管理</a></li>
										<li class="active"><span>暂缓流失</span></li>
									</ol>
									...
									<div class="main-box no-header clearfix">
										<div class="main-box-body clearfix">
											<div class="table-responsive">
												<form action="cuupdate?id=${cus.customerId}" method="post">
													<div align="center">
														<table align="right">
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="Allperson?customerId=${cus.customerId}" style="color: #06060B">联系人</a>
																		</button>
																	</div></td>
																	<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="jiaowang?customerId=${cus.customerId}" style="color: #06060B">交往记录</a>
																		</button>
																	</div></td>
																	<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="lishi?customerId=${cus.customerId}" style="color: #06060B">历史订单</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="information" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
												...
												<table class="table user-list table-hover"
													...
													<tr>
														<th class="info">客户编号</th>
														<td>${cus.customerNumber}</td>
														<th class="info">名称</th>
														<td><input type="text" value="${cus.customerName}" name="mingcheng"/><span style="color: red">*</span></td>
													</tr>
													<tr>
														<th class="info">地区</th>
														<td>
														<select name="diqu">
															<option value="${cus.customerRegion}" selected="selected">${cus.customerRegion}</option>
															<c:forEach items="${cusupda}" var="u">
															<option value="${u.customerRegion}">${u.customerRegion}</option>
															</c:forEach>			
														...
														<td>
														<select name="jingli">
														<option value="${cus.user.userId}" selected="selected">${cus.user.trueName}</option>
														<c:forEach items="${uselist}" var="user">
													...
													<tr>
														<th class="info">客户等级</th>
														<td>
															<select name="dengji">
																<option value="${cus.grade.gradeId}" selected="selected">${cus.grade.gradeName}</option>
													...
													<tr>
														<th class="info">客户满意度</th>
														<td><select name="manyi">
														<option value="${cus.satisfaction}" selected="selected"><c:if test="${cus.satisfaction==0}">未指定</c:if><c:if test="${cus.satisfaction==1}">☆</c:if><c:if test="${cus.satisfaction==2}">☆☆</c:if><c:if test="${cus.satisfaction==3}">☆☆☆</c:if><c:if test="${cus.satisfaction==4}">☆☆☆☆</c:if><c:if test="${cus.satisfaction==5}">☆☆☆☆☆</c:if></option>
														...
														<th class="info">客户信誉度</th>
														<td><select name="xinyu">
														<option value="${cus.credit}" selected="selected" ><c:if test="${cus.credit==0}">未指定</c:if><c:if test="${cus.credit==1}">☆</c:if><c:if test="${cus.credit==2}">☆☆</c:if><c:if test="${cus.credit==3}">☆☆☆</c:if><c:if test="${cus.credit==4}">☆☆☆☆</c:if><c:if test="${cus.credit==5}">☆☆☆☆☆</c:if></option>
														<option value="0">未指定</option>
														<option value="1">☆</option>
														<option value="2">☆☆</option>
														<option value="3">☆☆☆</option>
													...
													<tr>
														<th class="info">地址</th>
														<td>
														<input type="text" name="dizhi" value="${cus.customerAddr}"/><span style="color: red">*</span>
														</td>
														<th class="info">邮政编码</th>
														<td>
														<input type="text" name="youzheng" value="${cus.mail}"/><span style="color: red">*</span>
														</td>
													</tr>
													<tr>
														<th class="info">电话</th>
														<td>
														<input type="text" name="dianhua" value="${cus.customerrPhone}"/><span style="color: red">*</span>
														</td>
														<th class="info">传真</th>
														<td>
														<input type="text" name="chuanzhen" value="${cus.customerFax}"/><span style="color: red">*</span>
														</td>
													</tr>
													<tr>
														<th class="info">网址</th>
														<td>
														<input type="text" name="wangzhi" value="${cus.customerUrl}"/><span style="color: red">*</span>
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														<th class="info">营业执照注册号</th>
														<td>
														<input type="text" name="yingye" value="${cus.businessLicence}"/>
														</td>
														<th class="info">法人</th>
														<td>
														<input type="text" name="faren" value="${cus.corporation}"/><span style="color: red">*</span>
														</td>
													</tr>
													<tr>
														<th class="info">注册资金（万元）</th>
														<td>
														<input type="text" name="zijin" value="${cus.money}"/>
														</td>
														<th class="info">年营业额</th>
														<td>
														<input type="text" name="yee" value="${cus.annualTurnover}"/>
														</td>
													</tr>
														<tr>
														<th class="info">开户银行</th>
														<td>
														<input type="text" name="yinhang" value="${cus.openBank}"/><span style="color: red">*</span>
														</td>
														<th class="info">银行账号</th>
														<td>
														<input type="text" name="zhanghao" value="${cus.bankNumber}"/><span style="color: red">*</span>
														</td>
													</tr>
													<tr>
														<th class="info">地税登记号</th>
														<td>
														<input type="text" name="disui" value="${cus.landTax}"/>
														</td>
														<th class="info">国税登记号</th>
														<td>
														<input type="text" name="guosui" value="${cus.stateTax}"/>
														</td>
													</tr>
												</table>
												</form>
