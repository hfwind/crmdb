															...
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="fankuifuwu" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="chulijieguo" value="" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="number" value="" style="height: 30px;width: 200px;">最低1,最高10
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
	...
	<input type="submit" value="保存" class="form-control" style="background-color: #ccc"/>
</div>
						</form>
					</div>
