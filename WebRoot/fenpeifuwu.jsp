...
location="deleteService?serviceId="+id;
}
}
function xiugai(serviceId){
var kehuName=$("#kehuName").val();
location="xiugaifuwu?serviceId="+serviceId+"&kehuName="+kehuName;
}
</script>
  </head>
...
<li class="active"><span>服务分配</span></li>
</ol>
<div class="clearfix">
...
<form action="shaixuanService" method="post">
<div align="center">
<table>
	<tr>
		<td>客户名称</td>
		<td><input type="text" name="vo.kehuName" value="${vo.kehuName}" class="form-control" style="width: 300px"/></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td>概要</td>
		<td><input type="text" name="vo.prefile" value="${vo.prefile}" class="form-control" style="width: 300px"/></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td>服务类型</td>
		<td><select name="vo.fuwutype">
		...
		<td>&nbsp;&nbsp;</td>
		<td><div ><input type="button" value="帮助" class="form-control"/ style="background-color:#ccc "></div></td>
		<td>&nbsp;&nbsp;</td>
		<td><div ><input type="submit" value="查询" class="form-control"/ style="background-color:#ccc "></div></td>
	</tr>
	<tr>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
...
<span class="label label-warning">${m.profile}</span>
</td>
<td class="text-center">
${m.serviceType}
</td>
...
<td class="text-center">
<fmt:formatDate value="${m.serviceDate}" var="date" pattern="yyyy-MM-dd"/>${date }
</td>
<td class="text-center">
<select name="kuhuName" id="kehuName">
<option>请选择</option>
<c:forEach var="s" items="${uslist}">
<option value="${s.trueName}">${s.trueName}</option>
</c:forEach>
</select>
<input type="button" value="分配" onclick="xiugai(${m.serviceId})">
</td>
<td style="width: 15%;" class="text-center">
<a href="javascript:deleteservice(${m.serviceId},'${m.customerName}')" class="table-link danger" >
<span class="fa-stack">
...
<li>
<pg:pager items="${pageMax }" url="fenyeService" maxPageItems="2" maxIndexPages="3" export="curPage=pageNumber">
									<pg:first>
										<a href="<%=pageUrl%>">首页</a>
									</pg:first>
