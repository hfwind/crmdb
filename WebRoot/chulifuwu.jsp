...
function chakanxiangService(id){

location="xiangService?serviceId="+id;
...
<li class="active"><span>服务处理</span></li>
</ol>
<div class="clearfix">
...
<form action="shaixuanfenpei" method="post">
<div align="center">
<table>
	<tr>
		<td>客户名称</td>
...
<span class="label label-warning">${f.profile}</span>
</td>
<td class="text-center">
${f.serviceType}
</td>
...
<td class="text-center">
<fmt:formatDate value="${f.serviceDate}" var="date" pattern="yyyy-MM-dd"/>${date }
</td>

<td style="width: 15%;" class="text-center">
<a href="javascript:chakanxiangService(${f.serviceId})" class="table-link">
<span class="fa-stack">
...
<li>
<pg:pager items="${pageMax }" url="fenyeService" maxPageItems="4" maxIndexPages="4" export="curPage=pageNumber">
									<pg:first>
										<a href="<%=pageUrl%>">首页</a>
									</pg:first>
