					...
					<div class="row">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="index.jsp">客户流失管理</a></li>
									...
									<div class="main-box no-header clearfix">
										<div class="main-box-body clearfix">
											<div class="table-responsive">
												<form action="Byidliushiupda?id=${culoss.lossId}" method="post">
													<div align="center">
														<table align="right">
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="javascript:idzanhuan(${culoss.lossId})" style="color: #06060B">暂缓流失</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
												...
												<table class="table user-list table-hover"
													...
													<tr>
														<th class="info">编号</th>
														<td>${culoss.buy.customer.customerNumber}</td>
														<th class="info">客户</th>
														<td>${culoss.buy.customer.customerName}</td>
													</tr>
													<tr>
														<th class="info">客户经理</th>
														<td>${culoss.buy.customer.user.trueName}</td>
														<th class="info">上次下单时间</th>
														<td>${culoss.buy.buyDate}</td>
													</tr>
													<tr>
														<th class="info">暂缓措施</th>
														<td colspan="3">${culoss.reprieve}</td>
													</tr>
													<tr>
														<th class="info">流失原因</th>
														<td colspan="3"><textarea rows="6" cols="50" name="why">${culoss.lossWhy}</textarea><span
