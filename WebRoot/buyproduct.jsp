...
<table class="table">
<thead><!--  -->
<tr class="info"><td >订单编号&nbsp;:&nbsp;${buy.buyId}</td><td>日期&nbsp;:&nbsp;<fmt:formatDate value='${buy.buyDate}' pattern='yyyy-MM-dd' /></td></tr>
<tr class="info"><td >送货地址&nbsp;:&nbsp;${buy.buyAddr}</td><td>总金额(元)&nbsp;:&nbsp;${buy.totalMoney}</td></tr>
<tr class="danger"><td>订单状态:&nbsp;:&nbsp;${buy.state==1 ? "已回款":"未回款"}</td></tr>
</thead>
<tbody>
</tbody>
</table>
