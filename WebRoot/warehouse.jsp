...
<li class="active"><span>库存</span></li>
</ol>
<div class="clearfix">
<h1 class="pull-left">产品详情</h1>
...
<form class="form-inline" action="getProductToAjaxpei" method="post">
  <div class="form-group">
    <label for="exampleInputName2">产品名称:</label>
    <input type="text" class="form-control" id="exampleInputName2" name="vo.remark" value="${vo.remark}">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail2">仓库:</label>
    <input type="text" class="form-control" id="exampleInputEmail2" name="vo.war.warehouseName" value="${vo.war.warehouseName}">
  </div>
...
<th class="text-center"><span>仓库</span></th>
<th class="text-center"><span>数量</span></th>
<th class="text-center"><span>产品单价</span></th>
</tr>
</thead>
<tbody>
...
<span class="label label-warning">${p.war.warehouseName}</span>
</td>
<td class="text-center">
${p.productNum}
</td>
...
<li>
<pg:pager items="${pageMax}" url="findAllproductpage2" maxPageItems="2" maxIndexPages="2" export="curPage=pageNumber">
									<pg:first>
										<a href="<%=pageUrl%>">首页</a>
									</pg:first>
