					...
					<div class="row">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<div class="clearfix">
										<h1 class="pull-left">数据字典管理</h1>
										<div class="pull-right top-page-ui">
											<a href="#" class="btn btn-primary pull-right"> <i
												class="fa fa-plus-circle fa-lg"></i> 返回
											</a>
										</div>
									</div>
								</div>
									...
									<div class="main-box no-header clearfix">
										<div class="main-box-body clearfix">
											<div class="table-responsive">
												<form action="datatiaojian" method="post">
													<div align="center">
														<table>
															<tr>
																<td>类别:<input type="text"
																	name="vo.dataType" value="${vo.dataType}" class="form-control"
																	style="width: 300px" /></td>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																<td>条目:<input type="text" value="${vo.entry}" name="vo.entry"
																	class="form-control" style="width: 300px" /></td>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																<td>值:<input type="text" value="${vo.dataValue}" name="vo.dataValue"
																	class="form-control" style="width: 300px" /></td>
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="shujusysnav"
																				style="color: #06060B">新建</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
												...
												<table class="table user-list table-hover">
													<thead>
														<tr>
															<th class="text-center"><span>编号</span></th>
															<th class="text-center"><span>类别</span></th>
															<th class="text-center"><span>条目</span></th>
															<th class="text-center"><span>值</span></th>
															<th class="text-center"><span>是否可编辑</span></th>
															<th class="text-center"><span>操作</span></th>
														</tr>
													</thead>
													<tbody>
														<c:forEach var="l" items="${datalist}">
															<tr>
																<td class="text-center">${l.dataId}</td>
																<td class="text-center">
																	${l.dataType}</td>
																<td class="text-center">${l.entry}</td>
																<td class="text-center">${l.dataValue}</td>
																<td class="text-center"><c:if test="${l.state == 0 }">否</c:if><c:if test="${l.state == 1 }">是</c:if></td>
																<td style="width: 15%;" align="center"><r style="width: 15%;  <c:if test="${l.state==0}">visibility:hidden;</c:if>">
																<a href="javascript:Byshuju(${l.dataId})" class="table-link">
																<span class="fa-stack" title="编辑">
																<i class="fa fa-square fa-stack-2x"></i>
																<i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
																</span>
																</a>
																<a href="javascript:idDele(${l.dataId})" class="table-link danger" title="删除">
																<span class="fa-stack">
																<i class="fa fa-square fa-stack-2x"></i>
												...
												<ul class="pagination pull-right">
													<li><pg:pager items="${pageMax}" url="datafenye" maxPageItems="4" maxIndexPages="4" export="curPage=pageNumber">
															<pg:first>
																<a href="<%=pageUrl%>">首页</a>
															</pg:first>
