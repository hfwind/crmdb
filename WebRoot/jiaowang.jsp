...
<th class="text-center"><span>地点</span></th>
<th class="text-center"><span>概要</span></th>
<th class="text-center"><span>详情</span></th>
...
<span class="label label-warning">${c.profile}</span>
</td>
<td class="text-center">
${c.recordDesc}
</td>
...
<a href="jiaowangid?recordId=${c.recordId}"  class="table-link">
...
<a href="deleterecord?recordId=${c.recordId}" class="table-link danger">
