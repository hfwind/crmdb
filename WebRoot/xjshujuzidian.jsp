							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										...
										<li class="active"><span>新建数据字典条目</span></li>
									</ol>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2><input type="text" name="leibie"/><span style="color: red">*</span></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<h2><input type="text" name="tiaomu"/><span style="color: red">*</span></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2><input type="text" name="zhi"/><span>*</span></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<h2><input type="checkbox" name="bianji" value="1"/></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
