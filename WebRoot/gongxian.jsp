...
<li class="active"><span>客户贡献分析></span></li>
</ol>
<div class="clearfix">
...
<form action="shaixuangongxian" method="post">
<div align="center">
<table>
	<tr>
		<td>客户名称:<input type="text" name="vo.gongxianName" value="${vo.gongxianName}" class="form-control" style="width: 300px"/></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td>年份:<input type="text" name="vo.lineMan" value="${vo.lineMan}" class="form-control" style="width: 300px"/></td>
...
<th class="text-center"><span>订单金额</span></th>
</tr>
</thead>
<tbody>
<c:if test="${blist eq null}">null</c:if>
<c:forEach var="buy" items="${blist}">
<tr>
<td>
${buy[0]}
</td>
...
<td class="text-center">
<span class="label label-warning">${buy[2]}</span>
</td>
</tr>
</c:forEach>
