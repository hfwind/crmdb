					...
					<div class="row" >
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="Loss.jsp">权限管理</a></li>
										<li class="active"><span>分配</span></li>
									</ol>
															...
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="Sysnav" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="Sysnav" style="color: #06060B">帮助</a>
																		</button>
																	</div></td>
																<td><div style="padding-top: 19px;margin: 10px;">
...
<div class="row">
			     ...
			     <select name="role" onchange="getPower()">
			        <option>---请选择---</option>
			        <c:forEach var="r" items="${rolist}">
			         <option value="${r.roleId}">${r.roleName}</option>
			         </c:forEach>
			     </select>
			     <div id="section">
    					<ul id="content">
    					<c:forEach var="zhu" items="${list}">
    					<li>
    					<div><input onclick="clickall(${zhu.navId},this)" type="checkbox" id="power_${zhu.navId}" value="${zhu.navId}" name="pow"/>${zhu.navName}</div>
    					<ul>
    					<c:forEach var="fu" items="${alllist}">
    					<c:if test="${fu.pid==zhu.navId}">
    					<li><input type="checkbox" onclick="clickchild(${zhu.navId})" id="power_${zhu.navId}_${fu.navId}" value="${fu.navId}" name="pow"/>${fu.navName}</li>
    					</c:if>
    					</c:forEach>
    					</ul>
    					</li>
