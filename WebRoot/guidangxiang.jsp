            ...
            <c:if test="${zi.pid eq fu.navId}">
               <c:forEach var="po" items="${polist}">
				...
				<div id="content-wrapper">
					<div class="row" >
					<form action="tianxiejieguo" method="post">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="index.jsp">客户服务管理</a></li>
										<li class="active"><span>服务反馈详情</span></li>
									</ol>
															...
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="guidangfuwu" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
...
<header class="main-box-header clearfix" >
<input readonly="readonly" type="text" name="chuliId" value="${servicemanager.serviceId}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="" value="${servicemanager.serviceType}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea readonly="readonly" name="servicemanager.profile" >${servicemanager.profile}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="servicemanager.customerName" value="${servicemanager.customerName}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="servicemanager.state" readonly="readonly" value="2" style="height: 30px;width: 200px;">已分配
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea readonly="readonly" name="servicemanager.serviceRequest">${servicemanager.serviceRequest}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="servicemanager.createPerson" value="${user.trueName}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix" >
<input readonly="readonly" type="text" name="servicemanager.serviceDate" value="<%=str_date1 %>" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="" value="${servicemanager.procesPerson}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="" value="<%=str_date1 %>" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<textarea  readonly="readonly" name="jieguoName">${servicemanager.serviceProcssing}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="servicemanager.procesPerson" value="${servicemanager.procesPerson}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input readonly="readonly" type="text" name="${servicemanager.procesTime }" value="<%=str_date1 %>" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" readonly="readonly" name="chulijieguo" value="${servicemanager.procesResult}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id= "hero-graph"></div>
</div> n
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" readonly="readonly" name="number" value="${servicemanager.satisfaction}" style="height: 30px;width: 200px;">最低1,最高10
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
