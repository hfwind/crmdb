									 ...
									 <div class="main-box no-header clearfix" style="height:"><!-- 板块 -->
										<div class="main-box-body clearfix">
											<div class="table-responsive" >
												<form action="xiujiao?recordId=${con.recordId}" method="post">
													<div align="center">
													<h1>客户关系暂缓流失修改页</h1>
														<table align="right">
															<tr>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="con.recordDate" value="${con.recordDate}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="con.recordAddr" value="${con.recordAddr}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<input type="text" name="con.profile" value="${con.profile}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box">
<header class="main-box-header clearfix">
<input type="text" name="con.remark" value="${con.remark}">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<h2><textarea rows="3" cols="66" name="con.recordDesc"></textarea></h2>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
