            ...
            <c:if test="${zi.pid eq fu.navId}">
               <c:forEach var="po" items="${polist}">
				...
				<div id="content-wrapper">
					<div class="row" >
					<form action="fenxiaoshou?saleId=${salechance.saleId}" method="post">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
															...
															<tr>
																...
																<td><div style="padding-top: 19px;margin: 10px;">
																		<button type="button" class="form-control">
																			<a href="salefen" style="color: #06060B">返回</a>
																		</button>
																	</div></td>
...
<header class="main-box-header clearfix" >
<input type="text" name="salechance.saleId" value="${salechance.saleId}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.saleSource" value="${salechance.saleSource}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.customerName" value="${salechance.customerName}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.success" value="${salechance.success}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<textarea name="salechance.profile">${salechance.profile}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.linkman" value="${salechance.linkman}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix" >
<input type="text" name="salechance.linkTel" value="${salechance.linkTel}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" >
<header class="main-box-header clearfix">
<textarea name="salechance.desc">${salechance.desc}</textarea>
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name=salechance.founder value="${salechance.founder}" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.createTime" value="<fmt:formatDate value='${salechance.createTime}' pattern='yyyy-MM-dd' />" style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<select name="salechance.userinfo.userId" value="salechance.userinfo.trueName" style="height: 30px;width: 200px;">
<option value="0">请选择</option>
<c:forEach var="u" items="${userlist}">
<option value="${u.userId}">${u.trueName}</option>
</c:forEach>
</select>
</header>
<div class="main-box-body clearfix">
...
<div class="main-box" style="padding-top: 5px;">
<header class="main-box-header clearfix">
<input type="text" name="salechance.assignmentTime" value="<%=str_date1%>"  style="height: 30px;width: 200px;">
</header>
<div class="main-box-body clearfix">
<div id="hero-graph"></div>
</div>
