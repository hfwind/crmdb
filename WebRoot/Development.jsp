...
<thead>
<tr>
<th class="text-center"><a href="#"><span>计划日期</span></a></th>
<th class="text-center"><a href="#" class="asc"><span>计划详情</span></a></th>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<td class="text-center">
<input type="text" value="${p.planDesc}">
</td>
<td style="width: 15%;">
...
<a href="delete?pid=${p.planId}&saleId=${p.sale.saleId}" class="table-link danger">
<span class="fa-stack">
<i class="fa fa-square fa-stack-2x"></i>
<i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
</span>
</a>
<input type="hidden" value="${p.sale.saleId}" id="sale">
</td>
</tr>
</c:forEach>
</tbody>
...
<div class="row">
<form action="addPlan?saleId=${sc.saleId}" method="post">
<table class="table">
<thead>
<tr>
<th>计划日期&nbsp;:&nbsp;<input id="planDate" type="text" name="planDate">&nbsp;&nbsp;格式:YYYY-MM-DD&nbsp;&nbsp;&nbsp;计划详情&nbsp;:&nbsp;<input type="text" name="planDesc" id="planDesc"></th>
