 ...
 * 
 * @see com.demo.dao.impl.Warehouse
 * @author MyEclipse Persistence Tools
 */
public class WarehouseDaoImpl extends BaseHibernateDao {
	private static final Logger log = LoggerFactory
			.getLogger(WarehouseDaoImpl.class);
	// property constants
	...
	public Warehouse findById(java.lang.Integer id) {
		...
		try {
			Warehouse instance = (Warehouse) getSession().get(
					"com.demo.dao.impl.Warehouse", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Warehouse instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.demo.dao.impl.Warehouse")
